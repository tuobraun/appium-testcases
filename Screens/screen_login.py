...
class LoginScreenAndroid:
    ...
    def __init__(self, app):
        ...
        #LOGIN SCREEN:
        self.login_screen_logo = (MobileBy.ID, 'LoginFragment_Logo')
        self.login_screen_url = (MobileBy.ID, 'LoginFragment_Url')
        self.login_screen_usrnm = (MobileBy.ID, 'LoginFragment_UserName')
        self.login_screen_psswrd = (MobileBy.ID, 'LoginFragment_Password')
        self.login_screen_save_psswrd = (MobileBy.ID, 'LoginFragment_KeepPass')
        self.login_button = (MobileBy.ID, 'LoginFragment_LoginBtn')
        self.app_version = (MobileBy.ID, 'LoginFragment_VersionNumber')
